                ...
                <div className="space-y-4 pt-6 border-t">
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full min-h-[100px] p-4 rounded-xl border border-gray-200 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all resize-none"
                    />
                  </div>
